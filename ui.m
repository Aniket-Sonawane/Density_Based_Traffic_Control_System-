...
myArr = ['0' '3' '4' '1' '2' '5' '7' '8' '9' '6' '10' '11' '12' '13' '14'];   
...
if d==x
    ...
    elseif e==z
        ...
        if f==y
           ...
           set(handles.edit49,'string',60);
           set(handles.edit50,'string',60);
           set(handles.edit51,'string',60);
           set(handles.edit52,'string','60');
        else 
